...
function YouMightAlsoLike() {
  ...
  useEffect(() => {
    fetch("https://ecommerce-shop-d11c2-default-rtdb.firebaseio.com/youmightalsolike.json")
      .then((response) => {
            response.json().then((result) => {
              setyoumightalsolike(result);
            })
          })
        });
  return (
    <section className="max-w-[1260px] mx-auto text-center my-10 md:my-20 px-4 md:px-0">
      <h2 className="text-[37px] md:text-5xl mb-8 md:mb-14 font-integral font-[800]">
        YOU MIGHT ALSO LIKE
      </h2>
