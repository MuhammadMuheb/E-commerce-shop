      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 py-9 md:py-11 px-6 md:px-16 max-w-[1240px] mx-auto bg-black rounded-[20px]">
        ...
        <div className="flex items-center">
          <div className="flex flex-col w-full max-w-[349px] mx-auto">
            ...
            <button
              className="inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-secondary-foreground shadow-sm hover:bg-secondary/80 text-sm sm:text-base font-medium bg-white h-12 rounded-full px-4 py-3"
    ...
    <div className="max-w-[1240px] mx-auto">
      <nav className="lg:grid lg:grid-cols-12 mb-8">
        <div className="flex flex-col lg:col-span-3 lg:max-w-[248px]">
          ...
          <div className="flex items-center">
            ...
            <a
              className="bg-white hover:bg-black hover:text-white transition-all mr-3 w-7 h-7 rounded-full border border-black/20 flex items-center justify-center p-1.5"
              href="https://github.com/MuhammadMuheb"
            >
              <FaGithub />
            </a>
          </div>
      ...
      <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
        <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
          ...
          <a
            className="text-black font-medium"
            href="https://github.com/MuhammadMuheb/E-commerce-shop"
          >
            Muheb Riaz
          </a>
        </p>
