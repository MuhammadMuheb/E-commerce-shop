    ...
    <div className="max-w-[1240px] mx-auto px-4 xl:px-0">
      <nav className="mb-5 sm:mb-9">
        <ol className="flex flex-wrap items-center gap-1.5 break-words text-sm text-muted-foreground sm:gap-2.5">
          ...
          <li className=" text-[10px]"> <BsChevronRight/> </li>
          <li className="inline-flex items-center gap-1.5">
        ...
        <div className="flex flex-col w-full space-y-5">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="h-8 w-8 rounded-full bg-[#F0F0F0] text-black p-1 md:hidden data-state='closed'"
              >
            ...
            <div className="flex flex-col sm:items-center sm:flex-row">
             ...
             <div className="relative flex items-center">
                ...
                <button
                  ...
                  className="flex h-9 items-center justify-between whitespace-nowrap rounded-md py-2 px-1.5 font-medium text-sm sm:text-base w-fit text-black bg-transparent shadow-none border-none"
                >
                  {selectedPrice ? selectedPrice.name : "Most Popular"}
                  <BsChevronUp className={`ml-2 text-sm transition-transform ${isDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
